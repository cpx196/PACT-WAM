    ...
    def infer_action(
        ...
        if action_infer_mode == "idm":
            ...
            return FastWAMIDM.infer_action(
                ...
                action_guidance_trigger_reference_step=action_guidance_trigger_reference_step,
                action_guidance_trigger_decision_step=action_guidance_trigger_decision_step,
                action_guidance_trigger_ratio_threshold=action_guidance_trigger_ratio_threshold,
        ...
        if action_infer_mode == "first_frame":
            ...
            if num_action_candidates != 1:
                raise ValueError(
                    ...
                    "`action_infer_mode='idm'`, where all candidates share one imagined future."
                )
