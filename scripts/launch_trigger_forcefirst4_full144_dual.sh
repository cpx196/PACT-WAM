...
output_root=${OUTPUT_ROOT:-/data/pxchen/PACT-WAM/evaluate_results/trigger30_forcefirst4_rawgrad4x_long36_full144_shift1_cap0p02_20260923}
...
run_seed() {
    ...
    CUDA_VISIBLE_DEVICES="$gpu" MUJOCO_EGL_DEVICE_ID="$gpu" \
        ...
        EVALUATION.vjepa2_ac.guidance.trigger.force_first_replans=4 \
