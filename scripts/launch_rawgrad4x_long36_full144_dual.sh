...
output_root=/data/pxchen/PACT-WAM/evaluate_results/guidance789_rawgrad4x_long36_full144_shift1_cap0p02_20260922
...
run_gpu6() {
    run_seed 7 6 && run_seed 17 6
}

run_gpu7() {
    run_seed 27 7 && run_seed 37 7
}
